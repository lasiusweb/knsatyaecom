    ...
    <footer className="bg-brand-accent dark:bg-dark-surface text-brand-primary">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center mb-4">
              ...
              <h2 className="ml-2 text-xl font-bold">KN Biosciences</h2>
            </div>
            <p className="text-sm text-gray-300">Leading India in Agriculture, Aquaculture, and beyond since 1997.</p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-300">
              <li>Email: info@knbiosciences.com</li>
           ...
           <div>
            <h3 className="text-lg font-semibold mb-4">Follow Us</h3>
             <div className="flex space-x-4">
                <a href="#" className="text-gray-300 hover:text-brand-secondary">
        ...
        <div className="mt-8 border-t border-gray-700 pt-8 text-center text-sm text-gray-400">
          <p>&copy; {new Date().getFullYear()} K N Bio Sciences Private Limited. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
